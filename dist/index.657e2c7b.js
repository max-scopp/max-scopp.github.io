...
})({"clr4P":[function(require,module,exports) {
module.exports = require("./helpers/browser/js-loader")(require('./helpers/bundle-url').getBundleURL('gQdHU') + "home.0652f087.js" + "?" + Date.now()).catch((err)=>{
...
},{}]},[], null, "parcelRequire802f")
const $content = document.getElementById("content");
async function load(key) {
    let page = null;
    page = await parcelRequire802f("clr4P");
...
load(location.pathname.replace(/^\/+/, '') || 'home');
